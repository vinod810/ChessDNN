...
MAX_QS_MOVES_TIME_CRITICAL = _env_int('MAX_QS_MOVES_TIME_CRITICAL', 6)
...
QS_TIME_CHECK_INTERVAL = _env_int('QS_TIME_CHECK_INTERVAL', 35)
QS_TIME_BUDGET_FRACTION = _env_float('QS_TIME_BUDGET_FRACTION', 0.40)
